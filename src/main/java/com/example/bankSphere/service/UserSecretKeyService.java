...
public class UserSecretKeyService {
    ...
    public String generateAndStoreSecretKey(String username) {
        ...
        saveSecretKey(username, secretKeyBytes);
    ...
    private void saveSecretKey(String username, byte[] secretKeyBytes) {
    ...
    public String retrieveSecretKey(String username) {
        ...
        return secretKey.map(UserSecretKey::getSecretKey)
                .orElse(null);
    }
